...
Přidaná hodnota analytických nástrojů spočívá v nejen ve správném sběru, ale i v interpretaci nasbíraných dat. Většina údajů, podle kterých se orientujeme vzniká kombinací několika událostí, nebo informací.
\end{comment}
...
\subsection{Životní cyklus návštěvíka} % co to bude umět
