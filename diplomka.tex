...
Přidaná hodnota analytických nástrojů spočívá ve velké míře v interpretaci nasbíraných dat. Většina údajů, podle kterých se orientujeme vzniká kombinací několika událostí, nebo informací.

{\bf Počet unikátních uživatelů} 

{\bf Počet návštěv}

{\bf Opakování návštěv}
...
Poloha návštěvníků stránky se dá přibližně zjistit pomocí jejich IP adresy a zobrazuje se pomocí jednoduché mapy. Na obrázku \ref{img:analytics-map} je ukázka takové mapy, která znázorňuje počet návštěv pro Ameriku. Jendá se o statiskiku pro rozšíření do prohlížeče Google Chrome. Jelikož se jdná o rozšíření pro technické typy, lze usuzovat, že takoví se vyskytují v Kalifornii (tmavě zelená vlevo) a New Yorku.
...
Mimo laboratoř je možno takové obrázky vygenerovat z pohybů myší a klikání návštěvníků stránky.
...
{\bf Optimalizace kampaní}

{\bf Optimalizace konverze}
...
\subsubsection{Clickstream analýza}

\subsubsection{Měření konverze}
...
\subsubsection{Etická stránka sběru dat}
