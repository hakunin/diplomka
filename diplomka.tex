...
Výpis \ref{src:logfile_record} je ukázkou záznamu v logovacím souboru. Později docházelo k rozšíření tohoto formátu, aby obsahoval další zajímavé informace, které mohl analytický sofwtare zpracovávat. Význam jednotlivých částí typického řádku logovacího souboru jsou po\-psá\-ny v tabulce \ref{tab:http_log_info}.
...
\bibitem{peci_trendy} New York Times,
...
\begin{comment}
Jim Sterne: Social Media Metrics, Wiley (2010), ISBN 9780470583784, 272 stran
Avinash Kaushik: Web Analytics 2.0, Sybex (2009), ISBN: 9780470529393, 504 stran
