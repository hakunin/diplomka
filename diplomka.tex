...
Na obrázku \ref{img:user_story} je vidět takovýto jeden příběh.
...
Mimo jiné obsahuje aplikace i nástroje pro vývojáře, kteé generují náhodné data, jsou schopné importovat a exportovat data a spravovat metriky. Na obrázku \ref{img:developer_features} jsou jednotlivé metriky a jejich aktuální stav. V případě, že se nějaká metrika zasekne, je možno ji odlokovat, případně promazat data nebo zcela metriku odebrat.
