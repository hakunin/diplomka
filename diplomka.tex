...
--+ Hlavní stránka informačního serveru		
  |-- 1. Nejnovější článek		(počet zobrazení = dnešní popularita článku)
  |-- 2. Nejnovější článek		
  |-- 3. Nejnovější článek	
  ...
  |-- Kategorie článků A	(počet zobrazení = popularita kategorie)
  \-- Kategorie článků B  
\end{verbatim}
...
V kontextu webové aplikace se může jednat o údaj, který udává nejpoužívanější sadu funkcí.

\begin{verbatim}
--+ Hlavní stránka webové aplikace - administrace e-shopu
  |-+ Objednávky
