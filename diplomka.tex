...
\AddAcronym{PAAS}{Platforma jako služba (Platform as a Service)}
\AddAcronym{PPC}{Platba za proklik (Pay per click)}
\AddAcronym{PR}{Vztahy s veřejností (Public Relations)}
\AddAcronym{ROI}{Zisk z investice (Return on Investment)}
\AddAcronym{SAAS}{Software jako služba (Software as a Service)}
